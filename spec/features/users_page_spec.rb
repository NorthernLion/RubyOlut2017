...
describe "User" do
  ...
  describe "when have givent ratings" do
    before :each do
      style1 = FactoryGirl.create(:style, name: "Helles")
      create_beers_with_ratings(FactoryGirl.create(:brewery), style1, user, 7, 9)
      ...
      create_beers_with_ratings(FactoryGirl.create(:brewery), style1, user2, 50)

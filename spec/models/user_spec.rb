...
RSpec.describe User, type: :model do
  ...
  describe "favorite beer" do
    ...
    it "is the one with highest rating if several rated" do
      ...
      best = create_beer_with_rating(FactoryGirl.create(:brewery), style1, user, 25)
      create_beers_with_ratings(FactoryGirl.create(:brewery),  style1, user, 10, 20, 15, 7, 9)
  ...
  describe "favorite brewery" do
    ...
    it "is the brewery of only rated if only one rating" do
      ...
      beer = create_beer_with_rating(brewery, style1, user, 25)
    ...
    it "is the brewery with best average if many ratings" do
      ...
      style1 = FactoryGirl.create(:style)
      create_beers_with_ratings(FactoryGirl.create(:brewery), style1, user, 10, 7, 9)
      create_beers_with_ratings(best, style1, user, 35, 45)
      create_beers_with_ratings(FactoryGirl.create(:brewery), style1, user, 50, 10, 15, 20)
  ...
  describe "favorite style" do
    ...
    it "is the style of only rated if only one rating" do
      style1 = FactoryGirl.create(:style)
      create_beer_with_rating(FactoryGirl.create(:brewery) , style1, user, 25)
